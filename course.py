...
class CourseClass:
    ...
    #Title of Course
        title=Label(self.home,text="Manage Course",font=("times new roman",22,"bold"),bg="#CC3366",fg="white").place(x=0,y=0,relwidth=1,height=40)
    #Variables
    ...
    #Categories of Courses
        courseName = Label(self.home,text="Course Name",font=("times new roman",16,"bold"),bg="white").place(x=10,y=60)
        duration = Label(self.home,text="Duration",font=("times new roman",16,"bold"),bg="white").place(x=10,y=100)
        charges = Label(self.home,text="Charges",font=("times new roman",16,"bold"),bg="white").place(x=10,y=140)
        description = Label(self.home,text="Description",font=("times new roman",16,"bold"),bg="white").place(x=10,y=180)
    ...
    # Buttons
        self.add_btn=Button(self.home,text="Save",font=("times new roman",15,"bold"),bg="#240750",fg="white",cursor="hand2",command=self.add)
        self.add_btn.place(x=150,y=400,width=120,height=50)
        self.update_btn=Button(self.home,text="Update",font=("times new roman",15,"bold"),bg="#F97300",fg="white",cursor="hand2",command=self.update)
        self.update_btn.place(x=290,y=400,width=120,height=50)
        self.delete_btn=Button(self.home,text="Delete",font=("times new roman",15,"bold"),bg="#222831",fg="white",cursor="hand2",command=self.delete)
        self.delete_btn.place(x=430,y=400,width=120,height=50)
        self.clear_btn=Button(self.home,text="Clear",font=("times new roman",15,"bold"),bg="#FF2016",fg="white",cursor="hand2",command=self.clear)
        self.clear_btn.place(x=570,y=400,width=120,height=50)

    #Search Panel
        self.var_search=StringVar()
        search_courseName = Label(self.home,text="Search By Course Name",font=("times new roman",18,"bold"),bg="white").place(x=650,y=60)
        ...
        btn_search=Button(self.home,text="Search",font=("times new roman",16,"bold"),bg="#F97300",fg="white",cursor="hand2",command=self.search).place(x=1100,y=58,width=95,height=28)
